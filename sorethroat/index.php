...
<html>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <!-- Content goes here -->
			...
			<div class="col-md-6 col-sm-6 col-xs-12" id="one">
              <div class="info-box">
                <span class="info-box-icon bg-aqua"><i class="fa"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Unable to open mounth ?</span><br>
               <button onclick="storeSoreThroat('one','yes')">Yes</button>    <button  onclick="storeSoreThroat('one','no')">No</button>
						...
						<div class="col-md-6 col-sm-6 col-xs-12" id="two">
										<div class="info-box">
											<span class="info-box-icon bg-aqua"><i class="fa"></i></span>
											<div class="info-box-content">
												<span class="info-box-text">Unable to swallow any thing at all ?</span><br>
										 <button onclick="storeSoreThroat('two','yes')">Yes</button>    <button  onclick="storeSoreThroat('two','no')">No</button>
											</div><!-- /.info-box-content -->
										</div><!-- /.info-box -->
									</div><!-- /.col -->
						...
						<div class="col-md-6 col-sm-6 col-xs-12" id="diagnose">
										<div class="info-box">
										 ...
										 <button onclick="diagnoseSoreThroat('<?php echo  $_SESSION["caseId"]; ?>')" style="width:100px; height:40px; background:grey; border:1px solid grey; color:#fff">Submit</button>
											</div><!-- /.info-box-content -->
										</div><!-- /.info-box -->
									</div><!-- /.col -->
  ...
  <!--  <script src="../dist/js/pages/dashboard.js"></script> -->
    ...
    <script src="sorethroat.js"></script>
  </body>
</html>
